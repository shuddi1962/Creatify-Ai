...
const NEW_APPS = [
  ...
  { name: 'Reaction GIF', desc: 'Create reaction GIFs instantly', badge: 'NEW', credits: 4, url: 'https://picsum.photos/seed/rg/300/200' },
];
          ...
          {NEW_APPS.map((app, i) => (
            <div key={i} className="bg-[#111111] rounded-xl border border-white/[0.08] overflow-hidden group cursor-pointer">
              <div className="relative">
                ...
                <span className="absolute top-2 left-2 text-[10px] font-bold px-2 py-0.5 rounded bg-[#7C3AED] text-white">NEW</span>
              </div>
              <div className="p-4">
