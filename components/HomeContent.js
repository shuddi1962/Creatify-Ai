...
export default function HomeContent({ onTabChange }) {
  return (
    <div className="min-h-full bg-[#050505] text-white overflow-y-auto">
      {/* Hero */}
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#d9ff00] text-black font-bold text-sm hover:bg-[#e5ff33] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#d9ff00]/10 cursor-pointer"
              >
                Start Creating
          ...
          {tools.map((tool) => (
            ...
            >
              <div className="flex flex-col gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm text-white/90 group-hover:text-white transition-colors">{tool.label}</h3>
                  <p className="text-xs text-white/30 mt-1 leading-relaxed group-hover:text-white/40 transition-colors">{tool.desc}</p>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-28">
        <div className="text-center mb-14">
          ...
          <p className="text-white/40 text-base max-w-xl mx-auto">Get started in three simple steps.</p>
        </div>
        ...
        <div className="relative rounded-3xl overflow-hidden border border-white/[0.04] bg-gradient-to-br from-[#0a0a0a] to-[#050505]">
          ...
          <div className="relative p-10 md:p-16 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#d9ff00]/10 border border-[#d9ff00]/20 text-[#d9ff00] text-xs font-semibold mb-4">Open Source</div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Built for creators, by creators</h2>
              ...
              <div className="flex items-center gap-6 mt-6">
                <button
                  onClick={() => onTabChange?.('image')}
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white text-black font-semibold text-sm hover:bg-white/90 transition-all cursor-pointer"
                >
                  Get Started
                </button>
                <Link href="https://github.com/shuddi1962/Creatify-Ai" className="inline-flex items-center gap-2 text-sm text-white/40 hover:text-white transition-colors">
                  View on GitHub
      ...
      <section className="max-w-6xl mx-auto px-6 pb-28 text-center">
        ...
        <p className="text-white/40 text-base mb-8">No sign-up required. Just paste your API key and go.</p>
        <button
          onClick={() => onTabChange?.('image')}
          className="inline-flex items-center gap-2 px-10 py-4 rounded-full bg-[#d9ff00] text-black font-bold text-sm hover:bg-[#e5ff33] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#d9ff00]/10 cursor-pointer"
        >
          Launch Studio
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M5 12h14M12 5l7 7-7 7" />
