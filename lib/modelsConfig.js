...
export const IMAGE_MODELS = [
  { id: 'flux-schnell', name: 'Flux Schnell', endpoint: 'flux-schnell-image' },
  { id: 'sdxl-image', name: 'SDXL', endpoint: 'sdxl-image' },
  { id: 'hunyuan-image-3.0', name: 'Hunyuan Image 3.0', endpoint: 'hunyuan-image-3.0' },
  { id: 'qwen-image', name: 'Qwen Image', endpoint: 'qwen-image' },
  { id: 'wan2.6-text-to-image', name: 'WAN 2.6', endpoint: 'wan2.6-text-to-image' },
  { id: 'z-image-base', name: 'Z Image Base', endpoint: 'z-image-base' },
  { id: 'flux-2-klein-9b', name: 'Flux 2 Klein 9B', endpoint: 'flux-2-klein-9b' },
  { id: 'wan2.1-text-to-image', name: 'WAN 2.1', endpoint: 'wan2.1-text-to-image' },
  { id: 'wan2.5-text-to-image', name: 'WAN 2.5', endpoint: 'wan2.5-text-to-image' },
  { id: 'gpt-image-2', name: 'GPT Image 2', endpoint: 'gpt-image-2-text-to-image' },
  { id: 'midjourney-v7-text-to-image', name: 'Midjourney v7', endpoint: 'midjourney-v7-text-to-image' },
  { id: 'nano-banana-2', name: 'Nano Banana 2', endpoint: 'nano-banana-2' },
  { id: 'seedream-5.0', name: 'Seedream 5.0', endpoint: 'seedream-5.0' },
  { id: 'ideogram-v3-t2i', name: 'Ideogram v3', endpoint: 'ideogram-v3-t2i' },
  { id: 'bytedance-seedream-v4.5', name: 'Seedream v4.5', endpoint: 'bytedance-seedream-v4.5' },
  { id: 'flux-2-dev', name: 'Flux 2 Dev', endpoint: 'flux-2-dev' },
  { id: 'flux-2-pro', name: 'Flux 2 Pro', endpoint: 'flux-2-pro' },
  { id: 'flux-kontext-dev-t2i', name: 'Flux Kontext Dev', endpoint: 'flux-kontext-dev-t2i' },
  { id: 'grok-imagine-text-to-image', name: 'Grok Imagine', endpoint: 'grok-imagine-text-to-image' },
  { id: 'google-imagen4', name: 'Imagen 4', endpoint: 'google-imagen4' },
  { id: 'google-imagen4-ultra', name: 'Imagen 4 Ultra', endpoint: 'google-imagen4-ultra' },
  { id: 'kling-o1-text-to-image', name: 'Kling O1', endpoint: 'kling-o1-text-to-image' },
  { id: 'gpt4o-text-to-image', name: 'GPT-4o Image', endpoint: 'gpt4o-text-to-image' },
  { id: 'nano-banana-pro', name: 'Nano Banana Pro', endpoint: 'nano-banana-pro' },
  { id: 'minimax-image-01', name: 'MiniMax Image', endpoint: 'minimax-image-01' },
];
