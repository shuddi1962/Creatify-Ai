...
export const IMAGE_MODELS = [
  // Muapi models
  { id: 'flux-schnell-image', name: 'Flux Schnell (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'flux-schnell-image' },
  { id: 'sdxl-image', name: 'SDXL (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'sdxl-image' },
  { id: 'hunyuan-image-3.0', name: 'Hunyuan 3.0 (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'hunyuan-image-3.0' },
  { id: 'wan2.6-text-to-image', name: 'WAN 2.6 (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'wan2.6-text-to-image' },
  { id: 'qwen-image', name: 'Qwen (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'qwen-image' },
  { id: 'z-image-base', name: 'Z Image Base (Muapi)', provider: 'muapi', cost: 'free', endpoint: 'z-image-base' },
  { id: 'gpt-image-2', name: 'GPT Image 2 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'gpt-image-2-text-to-image' },
  { id: 'midjourney-v7-text-to-image', name: 'Midjourney v7 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'midjourney-v7-text-to-image' },
  { id: 'nano-banana-2', name: 'Nano Banana 2 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'nano-banana-2' },
  { id: 'seedream-5.0', name: 'Seedream 5.0 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'seedream-5.0' },
  { id: 'ideogram-v3-t2i', name: 'Ideogram v3 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'ideogram-v3-t2i' },
  { id: 'flux-2-dev', name: 'Flux 2 Dev (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'flux-2-dev' },
  { id: 'flux-2-pro', name: 'Flux 2 Pro (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'flux-2-pro' },
  { id: 'google-imagen4', name: 'Imagen 4 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'google-imagen4' },
  { id: 'kling-o1-text-to-image', name: 'Kling O1 (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'kling-o1-text-to-image' },
  { id: 'nano-banana-pro', name: 'Nano Banana Pro (Muapi)', provider: 'muapi', cost: 'paid', endpoint: 'nano-banana-pro' },
  // OpenRouter models (fallback via proxy)
  { id: 'or-flux-schnell', name: 'Flux Schnell (OpenRouter)', provider: 'openrouter', cost: 'free', endpoint: 'black-forest-labs/flux-schnell' },
  { id: 'or-flux-dev', name: 'Flux Dev (OpenRouter)', provider: 'openrouter', cost: 'free', endpoint: 'black-forest-labs/flux-dev' },
  { id: 'or-flux-pro', name: 'Flux Pro (OpenRouter)', provider: 'openrouter', cost: 'paid', endpoint: 'black-forest-labs/flux-pro' },
  { id: 'or-sdxl', name: 'SDXL (OpenRouter)', provider: 'openrouter', cost: 'free', endpoint: 'stabilityai/sdxl' },
  { id: 'or-sd-3.5', name: 'SD 3.5 Large (OpenRouter)', provider: 'openrouter', cost: 'paid', endpoint: 'stabilityai/stable-diffusion-3.5-large' },
  { id: 'or-dalle-3', name: 'DALL-E 3 (OpenRouter)', provider: 'openrouter', cost: 'paid', endpoint: 'openai/dall-e-3' },
  // Replicate models
  { id: 'rep-flux-schnell', name: 'Flux Schnell (Replicate)', provider: 'replicate', cost: 'free', endpoint: 'black-forest-labs/flux-schnell' },
  { id: 'rep-flux-dev', name: 'Flux Dev (Replicate)', provider: 'replicate', cost: 'free', endpoint: 'black-forest-labs/flux-dev' },
  { id: 'rep-flux-pro', name: 'Flux Pro (Replicate)', provider: 'replicate', cost: 'paid', endpoint: 'black-forest-labs/flux-pro' },
  { id: 'rep-sdxl', name: 'SDXL (Replicate)', provider: 'replicate', cost: 'free', endpoint: 'stability-ai/sdxl' },
  { id: 'rep-playground', name: 'Playground v2 (Replicate)', provider: 'replicate', cost: 'free', endpoint: 'playgroundai/playground-v2' },
];
