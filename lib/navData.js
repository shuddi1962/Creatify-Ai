...
export const TOP_NAV = [
...

  {
    ...
    features: [
      ...
      { icon: Mic,    name: 'Audio',        description: 'All voiceovers, music, and sound effects generated',     href: '/studio/media/audio' },
      { icon: Folder, name: 'Projects',     description: 'Organize your creations into named project folders',     href: '/studio/media/projects' },
    ],
    models: [
      { icon: HardDrive, name: 'Storage',     description: 'View your current storage usage and available space',   href: '/studio/media/storage' },
      { icon: Download,  name: 'Bulk Export', description: 'Download multiple assets as a ZIP file',               href: '/studio/media/download' },
    ],
  },
]
