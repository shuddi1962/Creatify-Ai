# Creatify AI: Technical Documentation & Context

This document serves as a comprehensive knowledge base for the Creatify AI project. It details the architecture, key components, API integration patterns, and state management strategies used in the application.

## 1. Project Vision & Overview

**Creatify AI** is an ambitious open-source project dedicated to **replicating the full functionality of the Higgsfield platform**.
...
- **Repository:** `https://github.com/shuddi1962/Creatify-Ai`
- **Primary Branch:** `main`
