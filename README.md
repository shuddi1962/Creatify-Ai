# Creatify AI — Uncensored Open-Source Alternative to AI Video Platforms
...
| Platform | Download |
|---|---|
| macOS Apple Silicon (M1/M2/M3/M4) | [Creatify AI-1.0.9-arm64.dmg](https://github.com/shuddi1962/Creatify-Ai/releases/download/v1.0.9/Creatify.AI-1.0.9-arm64.dmg) |
| macOS Intel (x64) | [Creatify AI-1.0.9.dmg](https://github.com/shuddi1962/Creatify-Ai/releases/download/v1.0.9/Creatify.AI-1.0.9.dmg) |
| Windows (x64) | [Creatify AI Setup 1.0.9.exe](https://github.com/shuddi1962/Creatify-Ai/releases/download/v1.0.9/Creatify.AI.Setup.1.0.9.exe) |
| Linux (Ubuntu x64) | [v1.0.9 release](https://github.com/shuddi1962/Creatify-Ai/releases/tag/v1.0.9) (`.AppImage` / `.deb`), or build locally with `npm run electron:build:linux`. |

All releases: [github.com/shuddi1962/Creatify-Ai/releases](https://github.com/shuddi1962/Creatify-Ai/releases)
...
```bash
xattr -cr "/Applications/Creatify AI.app"
```
...
3. Scroll down to find _"Creatify AI was blocked"_
...
- **AppImage** — portable, run directly after making executable:
  ```bash
  chmod +x "release/Creatify AI-*.AppImage"
...
> **Most users want the desktop app, not this dev path.** If you just want to run Creatify AI on your machine, [download a prebuilt installer](#-download-desktop-app) instead — no Node.js required. The instructions below are for contributors building from source.
...
git clone --recurse-submodules https://github.com/shuddi1962/Creatify-Ai.git
cd Creatify-Ai
...
Installers are output to the `release/` folder. Pre-built binaries are also available on the [Releases page](https://github.com/shuddi1962/Creatify-Ai/releases).
...
**Creatify AI** is a community-driven, open-source alternative that provides similar creative capabilities without the closed ecosystem:

| | Other providers | Creatify AI |
| :--- | :--- | :--- |
...
---
*Looking for a free, uncensored AI Video Plaform? Creatify AI is an open-source, unrestricted AI image and video generation studio — with no content filters that you can self-host, customize, and extend.*
